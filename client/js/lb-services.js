 ...
 */
  module.factory(
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/Invoices/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Invoice.hasItems.findById() instead.
            "prototype$__findById__hasItems": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/Invoices/:id/hasItems/:fk",
              method: "GET",
            },

            // INTERNAL. Use Invoice.hasItems.destroyById() instead.
            "prototype$__destroyById__hasItems": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/Invoices/:id/hasItems/:fk",
            ...
            // INTERNAL. Use Invoice.hasItems.updateById() instead.
            "prototype$__updateById__hasItems": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/Invoices/:id/hasItems/:fk",
            ...
            // INTERNAL. Use Invoice.hasItems() instead.
            "prototype$__get__hasItems": {
              isArray: true,
              url: urlBase + "/Invoices/:id/hasItems",
              method: "GET",
            },

            // INTERNAL. Use Invoice.hasItems.create() instead.
            "prototype$__create__hasItems": {
              url: urlBase + "/Invoices/:id/hasItems",
              method: "POST",
            },

            // INTERNAL. Use Invoice.hasItems.destroyAll() instead.
            "prototype$__delete__hasItems": {
              url: urlBase + "/Invoices/:id/hasItems",
              method: "DELETE",
            },

            // INTERNAL. Use Invoice.hasItems.count() instead.
            "prototype$__count__hasItems": {
              url: urlBase + "/Invoices/:id/hasItems/count",
              method: "GET",
            },
            ...
            // INTERNAL. Use InvoiceItem.belongsToInvoice() instead.
            "::get::InvoiceItem::belongsToInvoice": {
              url: urlBase + "/InvoiceItems/:id/belongsToInvoice",
              method: "GET",
            },
          }
        );
    ...
    /**
     * @ngdoc object
     * @name lbServices.Invoice.hasItems
     * @header lbServices.Invoice.hasItems
     * @object
     * @description
     *
     * The object `Invoice.hasItems` groups methods
     * manipulating `InvoiceItem` instances related to `Invoice`.
     *
     * Call {@link lbServices.Invoice#hasItems Invoice.hasItems()}
     ...
     */
             ...
             * <em>
             * (The remote method definition does not provide any description.
             * This usually means the response is a `InvoiceItem` object.)
             * </em>
             */
        R.hasItems = function() {
          var TargetResource = $injector.get("InvoiceItem");
          var action = TargetResource["::get::Invoice::hasItems"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Invoice.hasItems#count
             * @methodOf lbServices.Invoice.hasItems
             *
             * @description
             *
             * Counts hasItems of Invoice.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
             ...
             *  - `count` – `{number=}` -
             */
        R.hasItems.count = function() {
          var TargetResource = $injector.get("InvoiceItem");
          var action = TargetResource["::count::Invoice::hasItems"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Invoice.hasItems#create
             * @methodOf lbServices.Invoice.hasItems
             *
             * @description
             *
             * Creates a new instance in hasItems of this model.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
             ...
             * </em>
             */
        R.hasItems.create = function() {
          var TargetResource = $injector.get("InvoiceItem");
          var action = TargetResource["::create::Invoice::hasItems"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Invoice.hasItems#createMany
             * @methodOf lbServices.Invoice.hasItems
             *
             * @description
             *
             ...
             * </em>
             */
        R.hasItems.createMany = function() {
          var TargetResource = $injector.get("InvoiceItem");
          var action = TargetResource["::createMany::Invoice::hasItems"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Invoice.hasItems#destroyAll
             * @methodOf lbServices.Invoice.hasItems
             *
             * @description
             *
             * Deletes all hasItems of this model.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
             ...
             */
        R.hasItems.destroyAll = function() {
          var TargetResource = $injector.get("InvoiceItem");
          var action = TargetResource["::delete::Invoice::hasItems"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Invoice.hasItems#destroyById
             * @methodOf lbServices.Invoice.hasItems
             *
             * @description
             *
             * Delete a related item by id for hasItems.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
             *
             *  - `fk` – `{*}` - Foreign key for hasItems
             *
             * @param {function(Object,Object)=} successCb
             *   Success callback with two arguments: `value`, `responseHeaders`.
             *
             ...
             * This method returns no data.
             */
        R.hasItems.destroyById = function() {
          var TargetResource = $injector.get("InvoiceItem");
          var action = TargetResource["::destroyById::Invoice::hasItems"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Invoice.hasItems#findById
             * @methodOf lbServices.Invoice.hasItems
             *
             * @description
             *
             * Find a related item by id for hasItems.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
             ...
             * </em>
             */
        R.hasItems.findById = function() {
          var TargetResource = $injector.get("InvoiceItem");
          var action = TargetResource["::findById::Invoice::hasItems"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Invoice.hasItems#updateById
             * @methodOf lbServices.Invoice.hasItems
             *
             * @description
             *
             * Update a related item by id for hasItems.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
             ...
             * </em>
             */
        R.hasItems.updateById = function() {
          var TargetResource = $injector.get("InvoiceItem");
          var action = TargetResource["::updateById::Invoice::hasItems"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.InvoiceItem
 * @header lbServices.InvoiceItem
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `InvoiceItem` model.
 *
 * ## Example
 *
 * See
 ...
 */
  module.factory(
    ...
    [
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        var R = LoopBackResource(
        urlBase + "/InvoiceItems/:id",
          { 'id': '@id' },
          {

            // INTERNAL. Use InvoiceItem.belongsToInvoice() instead.
            "prototype$__get__belongsToInvoice": {
              url: urlBase + "/InvoiceItems/:id/belongsToInvoice",
              method: "GET",
            },
            ...
            /**
             * @ngdoc method
             * @name lbServices.InvoiceItem#create
             * @methodOf lbServices.InvoiceItem
             *
             * @description
             *
             * Create a new instance of the model and persist it into the data source.
             ...
             */
            "create": {
              url: urlBase + "/InvoiceItems",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.InvoiceItem#createMany
             * @methodOf lbServices.InvoiceItem
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.InvoiceItem#upsert
             * @methodOf lbServices.InvoiceItem
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.InvoiceItem#replaceOrCreate
             * @methodOf lbServices.InvoiceItem
             *
             * @description
             *
             ...
             */
            "replaceOrCreate": {
              url: urlBase + "/InvoiceItems/replaceOrCreate",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.InvoiceItem#upsertWithWhere
             * @methodOf lbServices.InvoiceItem
             *
             * @description
             *
             ...
             */
            "upsertWithWhere": {
              url: urlBase + "/InvoiceItems/upsertWithWhere",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.InvoiceItem#exists
             * @methodOf lbServices.InvoiceItem
             *
             * @description
             *
             ...
             */
            "exists": {
              url: urlBase + "/InvoiceItems/:id/exists",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.InvoiceItem#findById
             * @methodOf lbServices.InvoiceItem
             *
             * @description
             *
             ...
             */
            "findById": {
              url: urlBase + "/InvoiceItems/:id",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.InvoiceItem#replaceById
             * @methodOf lbServices.InvoiceItem
             *
             * @description
             *
             ...
             */
            "replaceById": {
              url: urlBase + "/InvoiceItems/:id/replace",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.InvoiceItem#find
             * @methodOf lbServices.InvoiceItem
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.InvoiceItem#findOne
             * @methodOf lbServices.InvoiceItem
             *
             * @description
             *
             ...
             */
            "findOne": {
              url: urlBase + "/InvoiceItems/findOne",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.InvoiceItem#updateAll
             * @methodOf lbServices.InvoiceItem
             *
             * @description
             *
             ...
             */
            "updateAll": {
              url: urlBase + "/InvoiceItems/update",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.InvoiceItem#deleteById
             * @methodOf lbServices.InvoiceItem
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.InvoiceItem#count
             * @methodOf lbServices.InvoiceItem
             *
             * @description
             *
             ...
             */
            "count": {
              url: urlBase + "/InvoiceItems/count",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.InvoiceItem#prototype$updateAttributes
             * @methodOf lbServices.InvoiceItem
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.InvoiceItem#createChangeStream
             * @methodOf lbServices.InvoiceItem
             *
             * @description
             *
             ...
             */
            "createChangeStream": {
              url: urlBase + "/InvoiceItems/change-stream",
              method: "POST",
            },

            // INTERNAL. Use Invoice.hasItems.findById() instead.
            "::findById::Invoice::hasItems": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/Invoices/:id/hasItems/:fk",
            ...
            // INTERNAL. Use Invoice.hasItems.create() instead.
            "::create::Invoice::hasItems": {
              url: urlBase + "/Invoices/:id/hasItems",
              method: "POST",
            },

            // INTERNAL. Use Invoice.hasItems.createMany() instead.
            "::createMany::Invoice::hasItems": {
              isArray: true,
              url: urlBase + "/Invoices/:id/hasItems",
              method: "POST",
            },
            ...
            // INTERNAL. Use Invoice.hasItems.destroyAll() instead.
            "::delete::Invoice::hasItems": {
              url: urlBase + "/Invoices/:id/hasItems",
              method: "DELETE",
            },

            // INTERNAL. Use Invoice.hasItems.count() instead.
            "::count::Invoice::hasItems": {
              url: urlBase + "/Invoices/:id/hasItems/count",
              method: "GET",
            },
          }
            ...
            /**
             * @ngdoc method
             * @name lbServices.InvoiceItem#patchOrCreate
             * @methodOf lbServices.InvoiceItem
             *
             * @description
             *
        ...
        R["patchOrCreate"] = R["upsert"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.InvoiceItem#updateOrCreate
             * @methodOf lbServices.InvoiceItem
             *
             * @description
             *
        ...
        R["updateOrCreate"] = R["upsert"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.InvoiceItem#patchOrCreateWithWhere
             * @methodOf lbServices.InvoiceItem
             *
             * @description
             *
        ...
        R["patchOrCreateWithWhere"] = R["upsertWithWhere"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.InvoiceItem#update
             * @methodOf lbServices.InvoiceItem
             *
             * @description
             *
        ...
        R["update"] = R["updateAll"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.InvoiceItem#destroyById
             * @methodOf lbServices.InvoiceItem
             *
             * @description
             *
        ...
        R["destroyById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.InvoiceItem#removeById
             * @methodOf lbServices.InvoiceItem
             *
             * @description
             *
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.InvoiceItem#patchAttributes
             * @methodOf lbServices.InvoiceItem
             *
             * @description
             *
        ...
        /**
        * @ngdoc property
        * @name lbServices.InvoiceItem#modelName
        * @propertyOf lbServices.InvoiceItem
        * @description
        * The name of the model represented by this $resource,
        * i.e. `InvoiceItem`.
        */
        R.modelName = "InvoiceItem";


            /**
             * @ngdoc method
             * @name lbServices.InvoiceItem#belongsToInvoice
             * @methodOf lbServices.InvoiceItem
             *
             * @description
             *
             * Fetches belongsTo relation belongsToInvoice.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
             ...
             * </em>
             */
        R.belongsToInvoice = function() {
          var TargetResource = $injector.get("Invoice");
          var action = TargetResource["::get::InvoiceItem::belongsToInvoice"];
          return action.apply(R, arguments);
        };
