  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Blog.reviews.findById() instead.
        "prototype$__findById__reviews": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/blogs/:id/reviews/:fk",
          method: "GET"
        },

        // INTERNAL. Use Blog.reviews.destroyById() instead.
        ...
        // INTERNAL. Use Blog.reviews.updateById() instead.
        ...
        // INTERNAL. Use Blog.reviews() instead.
        "prototype$__get__reviews": {
          isArray: true,
          url: urlBase + "/blogs/:id/reviews",
          method: "GET"
        },

        // INTERNAL. Use Blog.reviews.create() instead.
        "prototype$__create__reviews": {
          url: urlBase + "/blogs/:id/reviews",
          method: "POST"
        },

        // INTERNAL. Use Blog.reviews.destroyAll() instead.
        "prototype$__delete__reviews": {
          url: urlBase + "/blogs/:id/reviews",
          method: "DELETE"
        },

        // INTERNAL. Use Blog.reviews.count() instead.
        "prototype$__count__reviews": {
          url: urlBase + "/blogs/:id/reviews/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use Review.blog() instead.
        "::get::review::blog": {
          url: urlBase + "/reviews/:id/blog",
          method: "GET"
        },
      }
    );
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Blog.reviews
     * @header lbServices.Blog.reviews
     * @object
     * @description
     *
     * The object `Blog.reviews` groups methods
     * manipulating `Review` instances related to `Blog`.
     *
     * Call {@link lbServices.Blog#reviews Blog.reviews()}
     ...
     */
        ...
        R.reviews = function() {
          ...
          var action = TargetResource["::get::blog::reviews"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Blog.reviews#count
         * @methodOf lbServices.Blog.reviews
         *
         * @description
         *
         * Counts reviews of blog.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.reviews.count = function() {
          var TargetResource = $injector.get("Review");
          var action = TargetResource["::count::blog::reviews"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Blog.reviews#create
         * @methodOf lbServices.Blog.reviews
         *
         * @description
         *
        ...
        R.reviews.create = function() {
          var TargetResource = $injector.get("Review");
          var action = TargetResource["::create::blog::reviews"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Blog.reviews#createMany
         * @methodOf lbServices.Blog.reviews
         *
         * @description
         *
        ...
        R.reviews.createMany = function() {
          var TargetResource = $injector.get("Review");
          var action = TargetResource["::createMany::blog::reviews"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Blog.reviews#destroyAll
         * @methodOf lbServices.Blog.reviews
         *
         * @description
         *
        ...
        R.reviews.destroyAll = function() {
          var TargetResource = $injector.get("Review");
          var action = TargetResource["::delete::blog::reviews"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Blog.reviews#destroyById
         * @methodOf lbServices.Blog.reviews
         *
         * @description
         *
        ...
        R.reviews.destroyById = function() {
          var TargetResource = $injector.get("Review");
          var action = TargetResource["::destroyById::blog::reviews"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Blog.reviews#findById
         * @methodOf lbServices.Blog.reviews
         *
         * @description
         *
        ...
        R.reviews.findById = function() {
          var TargetResource = $injector.get("Review");
          var action = TargetResource["::findById::blog::reviews"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Blog.reviews#updateById
         * @methodOf lbServices.Blog.reviews
         *
         * @description
         *
        ...
        R.reviews.updateById = function() {
          var TargetResource = $injector.get("Review");
          var action = TargetResource["::updateById::blog::reviews"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Blog.reviews.createMany() instead.
        "::createMany::blog::reviews": {
          isArray: true,
          url: urlBase + "/blogs/:id/reviews",
          method: "POST"
        },
    ...
    */
    R.modelName = "Review";
        ...
        R.blog = function() {
          ...
          var action = TargetResource["::get::review::blog"];
          return action.apply(R, arguments);
        };
